 ...
 * from that map
 *
 * You may optionally override [deleteKeysWhenInvalidate]. This will be called on initialization
...
open class KPref(builder: KPrefBuilder = KPrefBuilderAndroid) : KPrefBuilder by builder {
    ...
    fun initialize(
        ...
        val toDelete = deleteKeysWhenInvalidate()
    ...
    open fun deleteKeysWhenInvalidate(): Array<String> = arrayOf()
}
