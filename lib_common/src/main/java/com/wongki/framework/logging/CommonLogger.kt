...
package com.wongki.framework.logging
...
open class CommonLogger(
    ...
    fun extend(tag: String) = CommonLoggerExtension(tag, this)
}

/**
 * Tag extender for [CommonLogger]
 ...
 */
class CommonLoggerExtension(val tag: String, val logger: CommonLogger) {
